...
/* 
	...
	Purpose:	Level tester for Move It!
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript">
			swfobject.embedSWF("../MoveItTest.swf?id=<?php echo $id;?>", "flashcontent", "550", "400", "9.0.0");
			</script>
	...
	<body>
		<div id='wrapper'>
			...
			<h3>Testing "<?php echo $name; ?>" - click level to start</h3>
			<h4>Creator:	<?php echo $creator; ?></h3>
			<h4>Last modified: <?php echo $modified; ?></h4>
			<h4><a href="edit.php?id=<?php echo $id;?>">Keep editing this level</a></h4>
			<div id='flashwrapper'>
				<div id='flashcontent'>
				</div>	
			</div>
